...
function Header() {
  ...
  //console.log('tv있는지 확인 : ', tvMatch); // 있으면 obj  없으면 null
  ...
  return (
    <Style.Nav animate={navAnimation} variants={navVariants} initial={'top'}>
      <Style.Col>
        <Style.Logo
        ...
        <Style.Items>
          <Style.Item>
            <Link to="/home">Home {homeMatch && <Style.Circle layoutId="circle" />}</Link>
          </Style.Item>
          <Style.Item>
            <Link to="/tv">Tv Shows {tvMatch && <Style.Circle layoutId="circle" />}</Link>
          </Style.Item>
        </Style.Items>
      </Style.Col>
      <Style.Col>
        <Style.Search onSubmit={handleSubmit(onValid)}>
          <motion.svg
